...
alias grelall="./gradlew clean assembleProductionRelease assembleProductionReleaseWithLogs assembleStagingDebug assembleStagingReleaseWithLogs"
alias add="adb devices"
alias iapk="adb install -r -t"
